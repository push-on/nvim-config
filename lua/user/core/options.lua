local options = {
    ...
    -- guifont = "CaskaydiaCove NF:h16" -- the font used in graphical neovim applications
    guifont = "OperatorMono Nerd Font:h16" -- the font used in graphical neovim applications
}
